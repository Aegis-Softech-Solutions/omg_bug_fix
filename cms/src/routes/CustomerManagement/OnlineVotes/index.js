...
import OnlineVotesTable from "./DisplayTable";
import CustomerViewForm from "../Customers/ViewForm";

const TabPane = Tabs.TabPane;

const OnlineVotes = props => {
  ...
  switch (useraction) {
    case "read":
      if (
        ...
        (userPermissions.includes("readCustomer") ||
          ...
          userPermissions.includes("updateVote"))
      ) {
        return (
          <Auxiliary>
            <CustomerViewForm
    ...
    default:
      if (userPermissions.includes("readVote")) {
        return (
          <Tabs defaultActiveKey="1">
            <TabPane tab="Females" key="1">
              <Row>
                <Col span={24}>
                  <OnlineVotesTable gender="f" />
                </Col>
              </Row>
            </TabPane>
...
export default connect(mapStateToProps)(OnlineVotes);
