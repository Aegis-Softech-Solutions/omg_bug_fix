...
import SearchList from "../sections/top-150/SearchListAlternate";
import { parseCookies } from "nookies";
import { initializeApollo } from "../utils/apollo-ssr-client";
import {
  CUSTOMER_DETAILS,
  TOP_75_LEADERBOARD_BY_SEARCH,
  CONTEST_STAGES,
    ...
    <>
      ...
      >
        ...
        <SearchList
          ...
          initialData={
            (data &&
              data.top75LeaderboardBySearch &&
              data.top75LeaderboardBySearch.top75LeaderboardBySearch) ||
            []
          }
        />
      </PageWrapper>
...
export async function getServerSideProps(ctx) {
  ...
  let top75LeaderboardBySearchResponse;

  try {
    top75LeaderboardBySearchResponse = await apolloClient.query({
      query: TOP_75_LEADERBOARD_BY_SEARCH,
      variables: {
    ...
    top75LeaderboardBySearchResponse = null;
  }
    ...
    props: {
      data: {
        customerDetails: customerDetailsResponse
          ...
          : null,
        top75LeaderboardBySearch: top75LeaderboardBySearchResponse
          ? top75LeaderboardBySearchResponse.data
          : null,
        searchTerm: search ? search : "",
