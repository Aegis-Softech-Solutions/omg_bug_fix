...
import SearchList from "../sections/top-40/SearchListAlternate";
import { parseCookies } from "nookies";
import { initializeApollo } from "../utils/apollo-ssr-client";
import {
  CUSTOMER_DETAILS,
  TOP_20_LEADERBOARD_BY_SEARCH,
  CONTEST_STAGES,
    ...
    <>
      ...
      >
        ...
        <SearchList
          ...
          initialData={
            (data &&
              data.top20LeaderboardBySearch &&
              data.top20LeaderboardBySearch.top20LeaderboardBySearch) ||
            []
          }
        />
      </PageWrapper>
...
export async function getServerSideProps(ctx) {
  ...
  let top20LeaderboardBySearchResponse;

  try {
    top20LeaderboardBySearchResponse = await apolloClient.query({
    ...
    top20LeaderboardBySearchResponse = null;
  }
    ...
    props: {
      data: {
        customerDetails: customerDetailsResponse
          ...
          : null,
        top20LeaderboardBySearch: top20LeaderboardBySearchResponse
          ? top20LeaderboardBySearchResponse.data
          : null,
        searchTerm: search ? search : "",
