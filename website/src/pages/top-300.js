...
import SearchList from "../sections/top-300/SearchListAlternate";
import { parseCookies } from "nookies";
import { initializeApollo } from "../utils/apollo-ssr-client";
import {
  CUSTOMER_DETAILS,
  TOP_150_LEADERBOARD_BY_SEARCH,
  CONTEST_STAGES,
    ...
    <>
      ...
      >
        ...
        <SearchList
          ...
          initialData={
            (data &&
              data.top150LeaderboardBySearch &&
              data.top150LeaderboardBySearch.top150LeaderboardBySearch) ||
            []
          }
        />
      </PageWrapper>
...
export async function getServerSideProps(ctx) {
  ...
  let top150LeaderboardBySearchResponse;

  try {
    top150LeaderboardBySearchResponse = await apolloClient.query({
      query: TOP_150_LEADERBOARD_BY_SEARCH,
      variables: {
    ...
    top150LeaderboardBySearchResponse = null;
  }
    ...
    props: {
      data: {
        customerDetails: customerDetailsResponse
          ...
          : null,
        top150LeaderboardBySearch: top150LeaderboardBySearchResponse
          ? top150LeaderboardBySearchResponse.data
          : null,
        searchTerm: search ? search : "",
