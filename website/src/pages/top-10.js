...
import SearchList from "../sections/top-10/SearchListAlternate";
import { parseCookies } from "nookies";
import { initializeApollo } from "../utils/apollo-ssr-client";
import {
  CUSTOMER_DETAILS,
  TOP_5_LEADERBOARD_BY_SEARCH,
  CONTEST_STAGES,
    ...
    <>
      ...
      >
        ...
        <SearchList
          ...
          initialData={
            (data &&
              data.top5LeaderboardBySearch &&
              data.top5LeaderboardBySearch.top5LeaderboardBySearch) ||
            []
          }
        />
      </PageWrapper>
...
export async function getServerSideProps(ctx) {
  ...
  let top5LeaderboardBySearchResponse;

  try {
    top5LeaderboardBySearchResponse = await apolloClient.query({
      query: TOP_5_LEADERBOARD_BY_SEARCH,
      variables: {
    ...
    top5LeaderboardBySearchResponse = null;
  }
    ...
    props: {
      data: {
        customerDetails: customerDetailsResponse
          ...
          : null,
        top5LeaderboardBySearch: top5LeaderboardBySearchResponse
          ? top5LeaderboardBySearchResponse.data
          : null,
        searchTerm: search ? search : "",
