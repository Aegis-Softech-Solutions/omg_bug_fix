...
import { UPLOAD_TOP_75_VIDEO } from "./queries.js";

const Top75Upload = ({ profileData }) => {
  const [showVideoModal, setShowVideoModal] = useState(false);

  const [introVideoPath, setIntroVideoPath] = useState(
    profileData && profileData.top_75_video_link
      ? profileData.top_75_video_link
      : undefined
  );
  ...
  const uploadVideo = (uploadTop75VideoMutation) => {
    let variables = {
    ...
    uploadTop75VideoMutation({ variables })
      .then((results) => {
        toast.notify("", {
          duration: 10,
          type: "success",
  ...
  return (
    <Mutation mutation={UPLOAD_TOP_75_VIDEO}>
      {(uploadTop75VideoMutation, { data, loading, error }) => (
        <Container>
            ...
            <React.Fragment>
              ...
              >
                <Button
                  ...
                  variant="custom"
                  borderRadius={10}
                  onClick={() => uploadVideo(uploadTop75VideoMutation)}
                >
                  Upload Video
                </Button>
              </div>
          ...
          >
            ...
            <Text variant="small" color="#000000">
              Capture yourself and show your story to the world. Create a video
              explaining your story by combining a maximum of 10 still photos
              (with you in each one of them) and add background music or
              voiceover. Your story can be anything below –<br />
              1. Your daily routine
              <br />
              2. Your Life journey
              <br />
              3. Your favourite Actor/Actress (Waking up as SRK, Ranveer Singh,
              Kareena Kapoor, Deepika Padukone etc.)
              <br />
              4. Your favourite imaginative character ( Iron Man, Wonder Woman,
              Politican, Padmavati, James Bond, Sportsman, etc)
              <br />
              5. Your Role model / Inspiration
              <br />
              6. Play with your creativity but make sure your story is well
              narrated to the judges.
              <br />
              <br />
              <br />
